...
function spam($no, $jum) {
	...
	if ($js->status == "correct") {
		echo "\033[1;32m] Sukses Mengirim Spam \033[1;35m\n";
	}else {
		echo "\033[1;32m] Gagal Mengirim Spam \033[1;35m\n";
		}
		}
	}
	echo "\n\033[1;32m/*       _\|/_
         (o o)
[•]×××××××××××××××××××oOO-{_}-OOo××××××××××××××××××[•]
[•]               \033[1;35m Tools Spam OYO\033[1;32m              [•]                                         
[•]      \033[34;1m Author By : Aditia Alfiansyah\033[36;1m  [•]                                                                                                              
[•]     \033[3%;1m WhatsApp : +1(313)2617183\033[36;1m  [•]                                                                                                                                                                 
[•]×××××××××××××××××××oOO-{_}-OOo××××××××××××××××××[•]\n\n";
    sleep(2);
    echo $banner;
	echo "\033[1;32m[!]Nomor Target => \033[1;33m";
	$no = trim(fgets(STDIN));
	sleep(1);
	echo "\033[1;32m[!]Jumlah Spam => \033[1;33m";
