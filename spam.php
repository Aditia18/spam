...
NOW=`date "+%d.%m.%Y"`
TIME=`date "+%H:%M"`
cowsay -f eyes "Tools Inside Heartz" | lolcat
toilet -f standard " WELCOME BOSS " -F gay
echo -e $blue'======================================================'
echo Tools Spammer | lolcat
echo -e $red'======================================================'
echo Whatsapp-: "+1 (313)2617183" | lolcat
echo Facebook-: "Aditia Alfiansyah" | lolcat
echo Team----:  "Tersakiti Crew" | lolcat
echo Twitter----: "@AditiaAlfians" | lolcat
echo -e $yellow'======================================================'
date | lolcat
echo -e $green'======================================================";
    sleep(2);
